...
{
  DEFINE_PAPER_SIMPLE( "w288h432", "4x6", PT(1382,334), PT(2048,334), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w288h432-div2", "2x6*2", PT1(1382,334), PT(2048,334), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "B7", "3.5x5", PT(1210,334), PT(1728,334), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w360h504", "5x7", PT(1728,334), PT(2380,334), DYESUB_PORTRAIT),
...
static const dyesub_pagesize_t kodak_9810_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "c8x10-div2", "8x5*2", PT(2464,300), PT1(3024,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w576h864", "8x12", PT(2464,300), PT(3624,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w576h864-div2", "8x6*2", PT(2464,300), PT1(3624,300), DYESUB_PORTRAIT),
};
...
static const dyesub_pagesize_t kodak_8810_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w576h576-div2", "8x4*2", PT1(2408,300), PT(2464,300), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "c8x10", "8x10", PT(2464,300), PT(3024,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "c8x10-div2", "8x5*2", PT(2464,300), PT1(3024,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "A4", "203x297mm", PT(2464,300), PT(3531,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w576h864", "8x12", PT(2464,300), PT(3624,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w576h864-div2", "8x6*2", PT(2464,300), PT1(3624,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w576h864-div3", "8x4*3", PT(2464,300), PT2(3624,300), DYESUB_PORTRAIT),
  /* Panorama sizes */
...
static const dyesub_pagesize_t mitsu_cp9550_page[] =
{
  DEFINE_PAPER_SIMPLE( "B7", "3.5x5", PT(1240,346), PT(1812,346), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w288h432", "4x6", PT(1416,346), PT(2152,346), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w288h432-div2", "2x6*2", PT1(1416,346), PT(2152,346), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w360h504", "5x7", PT(1812,346), PT(2452,346), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w432h576", "6x8", PT(2152,346), PT(2792,346), DYESUB_PORTRAIT),
...
static const dyesub_pagesize_t mitsu_cpd70x_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w288h432-div2", "2x6*2", PT1(1228,300), PT(1864,300), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w360h504", "5x7", PT(1568,300), PT(2128,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w360h504-div2", "3.5x5*2", PT(1568,300), PT1(2128,300), DYESUB_PORTRAIT),
  ...
  DEFINE_PAPER( "w432h576-div2", "4x6*2", PT(1864,300), PT1(2730,300), 0, 0, PT(236,300), 0, DYESUB_PORTRAIT),
#if 0 /* Theoretically supported, no way to test */
  DEFINE_PAPER( "w432h576-div4", "2x6*4", PT(1864,300), PT2(2730,300), 0, 0, PT(51,300), PT(51,300), DYESUB_PORTRAIT),
  DEFINE_PAPER( "w432h648-div3", "3x6*3", PT(1864,300), PT3(2730,300), 0, 0, PT(3, 300), PT(3, 300), DYESUB_PORTRAIT),
  DEFINE_PAPER( "w432h648-div2", "4.4x6*2", PT(1864,300), PT4(2730,300), 0, 0, PT(1, 300), PT(1, 300), DYESUB_PORTRAIT),
#endif
};
...
static const dyesub_pagesize_t mitsu_cpk60_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w288h432-div2", "2x6*2", PT1(1218,300), PT(1864,300), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w360h504", "5x7", PT(1568,300), PT(2128,300), DYESUB_PORTRAIT),
...
static const dyesub_pagesize_t mitsu_cpd90_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w288h432-div2", "2x6*2", PT1(1226,300), PT(1852,300),	DYESUB_LANDSCAPE),
...
static const dyesub_pagesize_t mitsu_cpm1_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w288h432-div2", "2x6*2", PT1(1232,300), PT(1852,300),	DYESUB_LANDSCAPE),
  ...
  DEFINE_PAPER_SIMPLE( "w432h576-div2", "4x6*2", PT(1852,300), PT1(2434,300), DYESUB_PORTRAIT),
...
static const dyesub_pagesize_t shinko_chcs2145_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w288h432", "4x6", PT(1240,300), PT(1844,300), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w288h432-div2",	"2x6*2", PT1(1240,300), PT(1844,300), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "B7", "3.5x5", PT(1088,300), PT(1548,300), DYESUB_LANDSCAPE),
  DEFINE_PAPER_SIMPLE( "w360h504", "5x7", PT(1548,300), PT(2140,300), DYESUB_PORTRAIT),
...
static const dyesub_pagesize_t shinko_chcs1245_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "c8x10-div2", "8x5*2", PT(2446,300), PT1(3070,300), DYESUB_PORTRAIT),
...
static const dyesub_pagesize_t shinko_chcs2245_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w432h576",	"6x8", PT(1844,300), PT(2434,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w432h576-div4",	"2x6*4", PT(1844,300), PT1(2434,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w432h576-div2", "4x6*2", PT(1844,300), PT(2492,300), DYESUB_PORTRAIT),
};
...
static const dyesub_pagesize_t dnpds40_page[] =
{
  ...
  DEFINE_PAPER( "w288h432-div2", "2x6*2", PT1(1240,300), PT(1920,300), 0, 0, PT(38,300), PT(38,300), DYESUB_LANDSCAPE),
  ...
  DEFINE_PAPER( "w432h576-div4", "2x6*4", PT(1920,300), PT1(2436,300), PT(38,300), PT(38,300), 0, 0, DYESUB_PORTRAIT),
...
static const dyesub_pagesize_t dnp_qw410_page[] =
{
  ...
  DEFINE_PAPER( "w288h288-div2", "2x4*2", PT1(1236,300), PT(1408,300), 0, 0, PT(71,300), PT(71,300), DYESUB_LANDSCAPE),
  DEFINE_PAPER( "w288h216", "4x3", PT(1836,300), PT(1408,300), PT(900,300), 0, PT(71,300), PT(71,300), DYESUB_LANDSCAPE),
  DEFINE_PAPER( "w288h288_w288h144", "4x4+4x2", PT(1408,300), PT1(1836,300), PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w288h432", "4x6", PT(1408,300), PT(1836,300), PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w288h432-div2", "4x3*2", PT(1408,300), PT2(1836,300), PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w288h432-div3", "2x4*3", PT(1408,300), PT3(1836,300), PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w288h576", "4x8", PT(1408,300), PT(2436,300), PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w288h432_w288h144", "4x6+4x2", PT(1408,300), PT1(2436,300), PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w288h432-div2_w288h144", "4x3*2+4x2", PT(1408,300), PT2(2436,300), PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w288h576-div2", "4x4*2", PT(1408,300), PT1(2436,300)+2, PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w288h576-div4", "2x4*4", PT(1408,300), PT1(2436,300)+3, PT(71,300), PT(71,300), 0, 0, DYESUB_PORTRAIT),
  ...
  DEFINE_PAPER( "w324h432-div2", "4.5x3*2", PT(1408,300), PT1(1836,300), 0, 0, 0, 0, DYESUB_PORTRAIT),
  ...
  DEFINE_PAPER( "w324h576-div2", "4.5x4*2", PT(1408,300), PT1(2436,300), 0, 0, 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w324h576-div4", "4.5x2*4", PT(1408,300), PT2(2436,300), 0, 0, 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w324h432_w324h144", "4.5x6+4.5x2", PT(1408,300), PT3(2436,300), 0, 0, 0, 0, DYESUB_PORTRAIT),
  DEFINE_PAPER( "w324h432-div2_w324h144", "4.5x3*2+4.5x2", PT(1408,300), PT4(2436,300), 0, 0, 0, 0, DYESUB_PORTRAIT),
};
...
static const dyesub_pagesize_t hiti_p520l_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w360h504", "5x7", PT(1548,300), PT(2140,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w360h504-div2", "3.5x5*2", PT(1548,300), PT1(2140,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w432h576", "6x8", PT(1844,300), PT(2434,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w432h576-div2", "4x6*2", PT(1844,300), PT1(2434,300), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w432h648", "6x9", PT(1844,300), PT(2740,300), DYESUB_PORTRAIT),
};
...
static const dyesub_pagesize_t hiti_p510l_page[] =
{
  ...
  DEFINE_PAPER_SIMPLE( "w360h504-div2", "3.5x5*2", PT(1548,301), PT1(2140,301), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w432h576", "6x8", PT(1844,301), PT(2434,301), DYESUB_PORTRAIT),
  DEFINE_PAPER_SIMPLE( "w432h576-div2", "4x6*2", PT(1844,301), PT1(2434,301), DYESUB_PORTRAIT),
